...
class Triangle(object):
    ...
    def area(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        S = .5 * (self.a.distance_from(self.b) + self.b.distance_from(self.c) + self.c.distance_from(self.a))
        A = (S * (S - self.a.distance_from(self.b)) * (S - self.b.distance_from(self.c)) * (S - self.c.distance_from(
            self.a))) ** .5
        return A
...
def run_test_return_doubled_triangle():
    ...
    # print("Actual: ", t1.return_doubled_triangle())
